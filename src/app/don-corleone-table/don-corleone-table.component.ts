...
@Component({
  selector: 'app-don-corleone-table',
  standalone: true,
  imports: [MatPaginatorModule, CommonModule, MatTableModule, MatIconModule],
  templateUrl: './don-corleone-table.component.html',
  styleUrl: './don-corleone-table.component.scss'
})
export class DonCorleoneTableComponent  implements OnInit, AfterViewInit, OnDestroy {
