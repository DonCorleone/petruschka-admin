...
import { DonCorleoneDialogComponent } from './__shared-utilities/don-corleone-dialog/don-corleone-dialog.component';
  ...
  showSnackbar(message?: string){
    setTimeout(()=>{
      let snackar_ref = this.snackbar.open(
        message || this.error_messages.service_failure,
        'OK',
        {panelClass: 'doncorleone-snackbar'});
